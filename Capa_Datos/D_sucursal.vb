...
Public Class D_sucursal
    ...
    Dim Tabla As String = "sucursal"


    'Inserta un articulo en la base de datos
    Public Function Insertar(ByVal _Elemento As E_sucursal) As Boolean
        Return QueryM(Tabla & "_insertar", _Elemento)
    End Function

    'Edita un articulo
    Public Function Editar(ByVal _Elemento As E_sucursal) As Boolean
        Return QueryM(Tabla & "_editar", _Elemento)
    End Function

    'Esta funcion se encarga de agregar, editar registros en la tabla articulo
    Private Function QueryM(ByVal Cadena As String, ByVal _Elemento As E_sucursal) As Boolean
        cn = objCon.conectar
