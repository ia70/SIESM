...
Public Class D_devolucion
    ...
    Dim Tabla As String = "devolucion"


    'Inserta un articulo en la base de datos
    Public Function Insertar(ByVal _Elemento As E_devolucion) As Boolean
        Return QueryM(Tabla & "_insertar", _Elemento)
    End Function

    'Edita un articulo
    Public Function Editar(ByVal _Elemento As E_devolucion) As Boolean
        Return QueryM(Tabla & "_editar", _Elemento)
    End Function

    'Esta funcion se encarga de agregar, editar registros en la tabla articulo
    Private Function QueryM(ByVal Cadena As String, ByVal _Elemento As E_devolucion) As Boolean
        cn = objCon.conectar
        ...
        Try
            ...
            With da.SelectCommand.Parameters
                ...
                .Add("acc", MySqlDbType.VarChar).Value = _Elemento.accion
                ...
                .Add("hora", MySqlDbType.VarChar).Value = _Elemento.hora
            End With
